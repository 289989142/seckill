package com.lhy.security.interceptor;


import com.lhy.core.utils.RedisUtils;
import com.lhy.security.annotation.IgnoreSecurity;
 ...
 * @Description 请求api服务器时，对accessToken进行拦截判断，有效则可以反问接口，否则返回错误
 * @Author lihengyu
